...
import { Truck, Tractor, Car, Shield, CheckCircle, ArrowRight } from "lucide-react";
  ...
  const services = [
    ...
    },
    {
      ...
      features: [
        ...
        "Life Insurance (Term & Investment plans)",
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-xl text-muted-foreground leading-relaxed">
              Comprehensive financial solutions tailored for your unique needs
            </p>
          </div>
        </div>
      </section>
